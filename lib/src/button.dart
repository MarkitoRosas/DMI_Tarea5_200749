...
String textButton = "❤️"; // Texto inicial del botón
...
class _MyButtonState extends State<MyButton> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Tarea5_200749",style: TextStyle(color: Colors.black),),
        backgroundColor: Colors.yellow, // Título de la barra de navegación
      ),
      body: Container(
        color: Colors.white, // Fondo negro para el cuerpo de la aplicación
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: <Widget>[
            Container(
              decoration: BoxDecoration(
                color: Color.fromARGB(255, 248, 224, 2),
